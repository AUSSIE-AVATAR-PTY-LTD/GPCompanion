      ...
      <main className="flex-1 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Meet the healthcare professional behind GP Companion</p>
          </div>
            ...
            <CardContent className="p-8">
              <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                <div className="flex-1">
                  <h2 className="text-3xl font-bold text-gray-900 mb-4">Dr. Bobby Tork MD, FRACGP-RG</h2>
...
{/* 
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="text-gray-600">MD, FRACGP-RG</p>
                    </div>

                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">SPECIALIZATION</h3>
                      <p className="text-gray-600">Rural Generalist</p>
                    </div>

                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">EDUCATION</h3>
                      <p className="text-gray-600">Melbourne Medical School</p>
                    </div>

                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">FOCUS</h3>
                      <p className="text-gray-600">Healthcare Systems & Patient Care</p>
                    </div>
                  </div> */}
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="rounded-xl border-gray-200 bg-white">
              <CardHeader>
                <CardTitle className="text-xl text-gray-900">Clinical Excellence</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="rounded-xl border-gray-200 bg-white">
              <CardHeader>
                <CardTitle className="text-xl text-gray-900">Innovation in Healthcare</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 leading-relaxed">
